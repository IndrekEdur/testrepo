...
urlpatterns = [
 ...
 path('project_import/', views.upload_xlsx_view, name='upload_xlsx'),
 path('remark_list/', views.ShowAllRemarks, name='showRemarks'),
 ...
 path('deleteRemark/<int:pk>/', views.deleteRemark, name='deleteRemark'),
